...
import static com.xmen.dc.source.TaildirSourceConfigurationConstants.BYTE_OFFSET_HEADER_KEY;
...
public class TailFile {
  ...
  public TailFile(File file, boolean isOpenRaf, Map<String, String> headers, long inode, long pos)
      throws IOException {
    if (isOpenRaf) {
  ...
  public boolean updatePos(long pos) throws IOException {
