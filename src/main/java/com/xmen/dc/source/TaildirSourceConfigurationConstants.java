...
public class TaildirSourceConfigurationConstants {
  ...
  /** Interval time (ms) to check the taildir list. */
  public static final String CHECK_DIR_AND_FILE_INTERVAL = "checkDirAndFileInterval";
  public static final int DEFAULT_CHECK_DIR_AND_FILE_INTERVAL = 300000;
